...
const REVIEW_UPDATES = [
  ...
  { slug: "xiaomi-redmi-note-14-price-nigeria-specs-review", title: "Xiaomi Redmi Note 14 Review — Verified Partner-Store Price", verdict: "At ₦349,999 on Jumia Nigeria, the Redmi Note 14 now has a verified partner-store price and stands as a strong midrange camera-first pick." },
